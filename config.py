...
class Config:
    SQLALCHEMY_DATABASE_URI = 'mssql+pyodbc://halonzo_SQLLogin_1:m11obohszi@GestionTareas.mssql.somee.com/GestionTareas?driver=ODBC+Driver+18+for+SQL+Server&TrustServerCertificate=yes'
